...
macro GDoxyClassHeaderComment()
{
	...
	InsBufLine(hbuf, ln, strHeader#"// add by chenzhongtao")
	ln = ln +1
...
macro GDoxyInsExampleCodes()
{
    ...
    lnCursor =lnCursor+1  ///<after the line of the cursor to insert the codes
...
var region
    ...
    {
       lIndicate = lIndicate+1//skip "{" character
...
macro GStrTrimJustify(string)
{
    ...
    rIndex = rIndex+ 1//strmid function will not get the character at rIndex palce
